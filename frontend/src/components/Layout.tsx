...
import { LayoutDashboard, Bot, BarChart3, GitBranch, Shield, ChevronLeft, LogOut, Settings, ClipboardList, LayoutGrid, Database, Server, Table2 } from 'lucide-react'
...
const navItems = [
  ...
  { path: '/datasources', icon: Server, label: '数据源管理' },
  { path: '/datasets', icon: Table2, label: '数据集管理' },
